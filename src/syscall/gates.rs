// Code (lightly) adapted from https://github.com/gmh5225/rust-mordor-rs.git by gmh5225
...
pub fn get_process_id_by_name(target_process: &str) -> usize {
    ...
    for process in system.processes_by_name(target_process.as_ref()) {
